...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void startRecording() {
        ...
        File file = new File(root.getAbsolutePath() + "/SesKayit/Audios");
        if (!file.exists()) {
            file.mkdirs();
        }

        fileName =  root.getAbsolutePath() + "/SesKayit/Audios/" + String.valueOf(System.currentTimeMillis() + ".mp3");
